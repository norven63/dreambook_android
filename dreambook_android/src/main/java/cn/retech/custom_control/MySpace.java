 ...
 */
public final class MySpace extends View {
	/**
	 * {@inheritDoc}
	 */
	public MySpace(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * {@inheritDoc}
	 */
	public MySpace(Context context, AttributeSet attrs) {
