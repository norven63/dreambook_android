...
public class RichTextPageContentView extends ImageView {
	/**
	 * 书籍操作回调接口
	 */
	...
	public RichTextPageContentView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		init();
	}

	public RichTextPageContentView(Context context, AttributeSet attrs) {
		super(context, attrs);

		init();
	}

	public RichTextPageContentView(Context context) {
		super(context);
