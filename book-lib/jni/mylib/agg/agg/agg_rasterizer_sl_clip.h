...
#pragma warning( disable : 4244 ) // int to float
    ...
    struct ras_conv_int
    {
		...
		static int upscale(int v){return (v*poly_subpixel_scale);}
    };

	struct ras_conv_none
	{
		typedef int coord_type;
		static AGG_INLINE int mul_div(float a, float b, float c)
		{
		...
		static int xi(int v) { return v; }
		static int yi(int v) { return v; }
		static int upscale(float v) { return iround(v); }
		static int downscale(int v) { return v; }
	};
	...
	typedef rasterizer_sl_clip<ras_conv_none>	  rasterizer_sl_clip_none; // @@@_modified _no conv
