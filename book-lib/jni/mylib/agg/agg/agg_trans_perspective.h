...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    inline void trans_perspective::translation(float* dx, float* dy) const
    {
        *dx = tx;
        *dy = ty;
    }
    ...
    //------------------------------------------------------------------------
    inline void trans_perspective::scaling(float* x, float* y) const
    {
        float x1 = 0.0;
        float y1 = 0.0;
        float x2 = 1.0;
    ...
    //------------------------------------------------------------------------
    inline void trans_perspective::scaling_abs(float* x, float* y) const
    {
