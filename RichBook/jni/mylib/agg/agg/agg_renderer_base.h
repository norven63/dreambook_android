...
namespace agg
{
    ...
    {
    public:
		typedef renderer_base<PixelFormat> self_type;
		...
		void blend_rect(int l,int t,int r,int b,const color_type& c, cover_type cover)
		{
			...
			for(y = t; y <= b; y++)
			{
				m_ren->blend_hline(l, y, len, c, cover);
			}
		}      
		...
		void blend_lcd_solid_hspan(int x,int y,int len,
			const color_type& c,const cover_type* covers)
		{
			...
			m_ren->blend_lcd_solid_hspan(x, y, len, c, covers);
		}
        //--------------------------------------------------------------------
		...
		void copy_solid_hspan(int x, int y, int len, const color_type& c)
		{
			...
			m_ren->copy_solid_hspan(x, y, len, c);
		}
		void invert_hspan(int x,int y,int len)
		{
			...
			m_ren->invert_hspan(x, y, len);
		}

		//--------------------------------------------------------------------
		void blend_solid_vspan(int x, int y, int len, const color_type& c)
		{
			if(x > xmax()) return;
			if(x < xmin()) return;
			...
			m_ren->copy_solid_vspan(x, y, len, c);
		}
		...
		void copy_color_hspan_repeat(int x, int y, int len, const color_type* colors,unsigned nSourceWidth)
		{
			if(y > ymax()) return;
			if(y < ymin()) return;
			...
			m_ren->copy_color_hspan_rep(x, y, len, colors,nSourceWidth);
		}
        ...
        //--------------------------------------------------------------------
        void copy_from(const self_type& src, 
        ...
        //--------------------------------------------------------------------
		// blend rect_src_ptf to rect_src_ptr+dx,dy from src
