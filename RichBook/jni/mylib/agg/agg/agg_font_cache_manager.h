...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        void signature(const TCHAR* font_signature)
        {
            m_font_signature = (TCHAR*)m_allocator.allocate((unsigned int)(tcslen(font_signature)) + 1);
			 tcscpy(m_font_signature,font_signature);
            //sprintf(m_font_signature, font_signature);
            memset(m_glyphs, 0, sizeof(m_glyphs));
        }

        //--------------------------------------------------------------------
        bool font_is(const TCHAR* font_signature) const
        {
            return tcscmp(font_signature, m_font_signature) == 0;
        }
    ...
    public:
        ...
        //--------------------------------------------------------------------
        void font(const TCHAR* font_signature, bool reset_cache = false)
        {
        ...
        //--------------------------------------------------------------------
        int find_font(const TCHAR* font_signature)
        {
            unsigned i;
            for(i = 0; i < m_num_fonts; i++)
            {
